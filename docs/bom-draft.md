...
| Pan motor | NEMA 11 or NEMA 14 stepper | 1 | ~$10–15. Sized for the light LiteFlow payload (§4.2 of the plan) — don't over-spec to NEMA 17. Direct-drive, co-located with the tilt motor in the single housing (rev B, §4.4 of the plan) — no belt/gear reduction. |
| Tilt motor | NEMA 11 or NEMA 14 stepper | 1 | ~$10–15. Direct-drive at the mirror mount, right next to the pan motor — the rev-B housing sits directly behind the mirror, so no remote pivot or belt run is needed. |
